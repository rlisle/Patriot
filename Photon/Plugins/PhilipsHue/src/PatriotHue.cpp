/******************************************************************
 ...
 Features:
 - Read and set Philips Hue light state.
 ...
 */
PatriotHue::PatriotHue(String name)
        : Device(name),
{
    _value = 0;
    _type  = 'H';
 ...
 */
bool PatriotHue::isTimeToCheckSwitch()
{
 ...
 */
bool PatriotHue::didSwitchChange()
{
