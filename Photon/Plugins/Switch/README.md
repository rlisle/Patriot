...
void setup() {
    ...
    Device *switch1 = Switch(kSwitch4Pin, 'WakeUp');
    Device *switch2 = Switch(kSwitch3Pin, 'WatchTV');
    Device *switch3 = Switch(kSwitch2Pin, 'Cook');
    Device *switch4 = Switch(kSwitch1Pin, 'Sleep');
